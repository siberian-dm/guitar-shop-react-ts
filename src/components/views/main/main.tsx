          ...
          <div className="container header__wrapper">
            ...
            <nav className="main-nav">
              <ul className="main-nav__list">
                <li><a className="link main-nav__link link--current" href="#no_scroll">Каталог</a>
                </li>
                <li><a className="link main-nav__link" href="#no_scroll">Где купить?</a>
                </li>
                <li><a className="link main-nav__link" href="#no_scroll">О компании</a>
                </li>
              </ul>
            </nav>
            ...
            <div className="catalog">
              ...
              <div className="cards catalog__cards">
                <div className="product-card">
                  ...
                  <div className="product-card__buttons"><a className="button button--mini" href="#no_scroll">Подробнее</a><a className="button button--red button--mini button--add-to-cart" href="#no_scroll">Купить</a>
                  </div>
                </div>
                <div className="product-card">
                  ...
                  <div className="product-card__buttons"><a className="button button--mini" href="#no_scroll">Подробнее</a><a className="button button--red-border button--mini button--in-cart" href="#no_scroll">В Корзине</a>
                  </div>
                </div>
                <div className="product-card">
